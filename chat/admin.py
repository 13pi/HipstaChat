...
from HipstaChat.models import HCUser, HCUserManager
...
class CustomUserChangeForm(UserChangeForm):
	password=ReadOnlyPasswordHashField(label='password',help_text="""You can change the password using <a href=\"password/\"> form </a>""")
